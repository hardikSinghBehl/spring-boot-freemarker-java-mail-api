...
public class ApiConstant {
	...
	public final static String BASE_USER_PATH = "/user";
	public static final String ACCOUNT_CREATION_SUCCESS_SUMMARY = "Account Created Successfully!";
	...
	public static final String FAILURE_STATUS = "Failed to execute";
}
