...
<table valign="top" class="bg-light body" style="outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; color: #000000; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin: 0; padding: 0; border: 0;" bgcolor="#f8f9fa" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td valign="top" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; font-family: unset; margin: 0;" align="left" bgcolor="#f8f9fa">
...
<table class="card " border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px; width: 100%; overflow: hidden; border: 1px solid #dee2e6;" bgcolor="#ffffff">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; font-family: unset; margin: unset;" align="left">
        <table border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px; width: 100%; overflow: hidden; border: 1px solid #dee2e6;" bgcolor="#ffffff">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; font-family: unset; margin: 0;" align="left">
        <div>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; font-family: unset; margin: 0; padding: 20px;" align="left">
        <div>
               <h1 align="center" class="font-weight-bold " style="margin-top: 0; margin-bottom: 0; font-weight: bold !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px;">We Welcome You!</h1>
    ...
    <tr>
      <td height="0" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; font-family: unset; margin: unset;" align="left">
         
               ...
               <h5 class="text-muted" align="center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Hello ${fullName}, Congratulations on successfully registering your account with our Dummy POC Application..</h5>
    ...
    <tbody>
      <tr>
        <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dddddd; border-top-style: solid; height: 1px; width: 100%; font-family: unset; margin: 0;" align="left"></td>
               ...
               <table class="alert alert-warning" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; width: 100%; border: 0;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; color: #6d5200; font-family: unset; margin: unset; padding: 12px 20px; border: 1px solid transparent;" align="left" bgcolor="#fff4d3">
        <table border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; width: 100%; border: 0;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; color: #6d5200; font-family: unset; margin: 0; padding: 12px 20px; border: 1px solid transparent;" align="left" bgcolor="#fff4d3">
        <div align="center">
                  You can Star the github repo and use it as a reference
               </div>
      </td>
    </tr>
  </tbody>
...
<h5 align="center" class="text-muted " style="margin-top: 0; margin-bottom: 13; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">This proof-of-concept is made using <span class="font-weight-bold" style="font-weight: bold !important;">Spring Boot, Apache Freemarker, Bootstrap-Email Editor and JavaMail-API.</span>
</h5>
               <div align="center">
                 <h5 align="center" class="text-muted " style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; color: #636c72;">Now go drink a glass of water for me, cheers.</h5>
               <div align="center">
                  <table class="s-3 w-100 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
...
<table class="btn btn-warning " border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; font-family: unset; margin: unset;" align="center" bgcolor="#ffc107">
        <table border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; font-family: unset; margin: 0;" align="center" bgcolor="#ffc107">
        <a href="https://github.com/hardikSinghBehl/spring-boot-freemarker-java-mail-api" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #ffc107; color: #111111; padding: 8px 12px; border: 1px solid #ffc107;">Go to Github Repository</a>
      </td>
    </tr>
  </tbody>
</table>
        ...
        <table class="s-1 w-100 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
      <td height="0" style="border-spacing: 0px; border-collapse: collapse; line-height: 4px; font-size: 4px; width: 100%; height: 4px; font-family: unset; margin: unset;" align="left">
         
      </td>
    </tr>
  </tbody>
...
<p align="right" class="text-muted " style="line-height: 24px; font-size: 16px; width: 100%; color: #636c72; margin: 0;">This Was An Automated Email Sent To ${emailId}, Please Do Not Reply</p>
