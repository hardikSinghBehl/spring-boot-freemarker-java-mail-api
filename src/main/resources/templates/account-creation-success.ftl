...
<table class="s-3 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; color: #6d5200; margin: 0; padding: 12px 20px; border: 1px solid transparent;" align="left" bgcolor="#fff4d3">
        <div align="center">
...
<table class="btn btn-warning " border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center" bgcolor="#ffc107">
...
<p align="right" class="text-muted " style="line-height: 24px; font-size: 16px; width: 100%; color: #636c72; margin: 0;">This Was An Automated Email Sent To ${email}, Please Do Not Reply</p>
